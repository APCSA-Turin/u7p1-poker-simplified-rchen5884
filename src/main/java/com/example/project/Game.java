...
public class Game {
    public static String determineWinner(Player p1, Player p2, String p1Hand, String p2Hand, ArrayList<Card> communityCards) {   
        ...
        // Gets the highest card by getting the last card since it is sorted
    ...
    public static void play() { 
        ...
        // Runs until the player chooses to stop playing
        while (play) {
            Deck deck = new Deck(); 
            ...
            for (int i = 0; i < 3; i++) {  // draws 3 cards for community cards
            ...
            // adds a victory count to the players when they win (or draw count)
